...
export default function PostCreation() {
  ...
  const fileRef = useRef(null); // select any jsx
  ...
  const { mutate, isPending } = useMutation({
    ...
    onError: () => {
      toast.error("Can't Create This Post Now...! ❌", { autoClose: 2000 });
    },
  });
  ...
  return (
    <>
      <div className="rounded-2xl border border-slate-200 bg-gray-100 p-4 shadow-sm">
        <div className="mb-3 flex items-start gap-3">
          ...
          <div className="flex-1">
            ...
            <div className="mt-1 inline-flex items-center gap-2 rounded-full bg-blue-400   px-2 py-0.5 text-xs text-black font-semibold">
